            ...
            <main class="col-md-9">
                ...
                <div class="container">
                    <div class="dashboard-item">
                        ...
                        <p><?php $myname=$_GET ['about']; echo $myname;?></p>
                    </div>
                         <div class="dashboard-item">
                        <div id="about-me" class="section-title">
                            <h2>Description</h2>
                        </div>
                        <p><?php $myname=$_GET['php']; echo $myname;?></p>
                    </div>
                        ...
                        <p><?php $myname=$_GET['MCA']; echo $myname;?></p>
                    </div>
                    ...
                    <div class="dashboard-item">
                        ...
                        <div class="btn-group">
                            <button class="ocean-blue-button gradient-button">Dynamic to static</button>
                        </div>
                    </div>
